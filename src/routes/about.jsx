...
export default function About() {
  return (
    <main class="text-center mx-auto text-gray-700 p-4 flex justify-center items-center flex-col">
      <h1 class="max-6-xs text-6xl text-sky-700 font-thin uppercase my-16">
        About Page
      </h1>
       <div className="lg:w-1/2 w-full mb-20">
           <h1 className={'text-3xl'}>Hi! I'm AG and I'm a Full Stack Developer</h1>
           <p className={'text-lg mb-5'}>This Website is just a Sample Landing Page. If you want to have a website like this, please do contact me on my contact information below.
               Also if you have any feedback to improve the existing design please leave a comment and click submit button. Thanks!</p>
           ...
           <div className="bg-white shadow-lg p-5 rounded-lg flex flex-col items-center justify-center mb-10">
               ...
               <table>
                   ...
                   <tr>
                       ...
                       <td className={'text-left p-3'}><a href="https://www.linkedin.com/in/ag-nieve-32565a212/">AG Nieve</a></td>
                   </tr>
                   </tbody>
               </table>
           </div>
            <div className={'bg-secondary p-5 rounded-2xl'}>
                <form action="">
                    ...
                    <div className={'flex flex-col mb-5'}>
                        <input className={'h-10 px-5 border-2 border-slate-100 rounded-full py-6'} type={'text'} id={'name'} placeholder={'Full Name'} />
                    </div>
                    <div className={'flex flex-col mb-5'}>
                        <input className={'h-10 px-5 border-2 border-slate-100 rounded-full py-6'} type={'email'} id={'email'} placeholder={'Your Email'} />
                    </div>
                    <div className={'flex flex-col'}>
                        <textarea placeholder={'Feedback/Comment'} className={'p-5 border-2 border-slate-100 rounded-2xl'} id="comment" cols="30" rows="5"></textarea>
                    </div>
